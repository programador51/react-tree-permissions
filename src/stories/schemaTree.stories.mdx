...
<Meta title="Tree/Schema Tree" />

# Schema tree

In order to use the component, it must be provided a `permissions` tree
which indicates how will be rendered the set of permissions with their
children and parent.
...
This is an example of the `PermissionI` that can be provided to the
component

```js
// anyFolderOnYourProject/schemaTree.js
